        ...
        >
          <GlassCard className="h-full p-8 md:p-12">
            ...
            >
              ...
              <button
                type="submit"
                className="mt-4 flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 px-6 rounded-lg transition-all shadow-sm hover:shadow-none md:hover:shadow-[0_0_20px_rgba(59,130,246,0.4)]"
              >
                Send Message
        ...
        >
          ...
          <GlassCard className="p-8 flex-grow">
            ...
            <div className="flex gap-4">
              <a href="#" className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:border-blue-500/50 hover:bg-blue-500/10 hover:shadow-sm md:hover:shadow-[0_0_15px_rgba(59,130,246,0.3)] transition-all">
